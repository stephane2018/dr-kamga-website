...
import { Sprout, Factory, Globe, Shield, Play, Users, BookOpen, User, Wheat, Tractor, Leaf } from "lucide-react"
...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-primary agricultural-pattern py-24 overflow-hidden">
        <div className="absolute inset-0 wheat-pattern opacity-20"></div>
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" variant="secondary" asChild>
                  <Link href="#programme">Découvrir la méthode</Link>
                </Button>
                <Button
                  size="lg"
                  variant="outline"
                  ...
                  asChild
                >
                  <Link href="/videos">Voir une vidéo gratuite</Link>
                </Button>
              </div>
            </div>
            <div className="relative">
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-primary-foreground to-secondary/20 rounded-[2.5rem] p-2 shadow-2xl">
                  <img
                    src="/kamga.jpg"
                    alt="Cabinetdab - Expert en agriculture internationale"
                ...
                <div className="absolute -top-4 -left-4 w-12 h-12 bg-secondary rounded-full flex items-center justify-center shadow-lg">
                  <Wheat className="h-6 w-6 text-secondary-foreground" />
                </div>
                <div className="absolute -bottom-4 -right-4 w-12 h-12 bg-accent rounded-full flex items-center justify-center shadow-lg">
                  <Tractor className="h-6 w-6 text-accent-foreground" />
                </div>
                <div className="absolute top-1/2 -right-6 w-10 h-10 bg-primary/80 rounded-full flex items-center justify-center shadow-lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
              4 formats pédagogiques adaptés à votre niveau et vos objectifs, pour une montée en compétences
              progressive.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center justify-between mb-6">
                <Badge className="bg-primary text-primary-foreground px-3 py-1 text-sm font-semibold">NIVEAU 1</Badge>
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center">
                  <Play className="h-6 w-6 text-primary" />
                </div>
              </div>

              <h3 className="text-2xl font-bold text-gray-900 mb-2">Vidéos Pédagogiques</h3>
              <p className="text-primary font-semibold mb-4">Commencer par des vidéos</p>

              <p className="text-gray-600 mb-6 leading-relaxed">
                Apprenez à votre rythme avec des capsules courtes et des cours structurés. Idéal pour débuter votre
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-600 text-sm">Capsules de 5-15 minutes</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full"></div>
                  <span className="text-gray-600 text-sm">Cours structurés par thématique</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full"></div>
                  <span className="text-gray-600 text-sm">Accès illimité 24h/24</span>
                </div>
              </div>
              ...
              <Button
                ...
                asChild
              >
                <Link href="/videos">Découvrir les vidéos</Link>
              </Button>
            </div>

            {/* Niveau 2 - Masterclass */}
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center justify-between mb-6">
                <Badge className="bg-primary text-primary-foreground px-3 py-1 text-sm font-semibold">NIVEAU 2</Badge>
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center">
              ...
              <p className="text-primary font-semibold mb-4">Approfondir avec des masterclass</p>

              <p className="text-gray-600 mb-6 leading-relaxed">
                Sessions expertes et interactives avec Cabinetdab. Perfectionnez vos connaissances sur des sujets
                spécifiques.
              </p>
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full"></div>
                  <span className="text-gray-600 text-sm">Sessions live de 2h</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full"></div>
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full"></div>
                  <span className="text-gray-600 text-sm">Replays disponibles</span>
                </div>
              </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center justify-between mb-6">
                <Badge className="bg-primary text-primary-foreground px-3 py-1 text-sm font-semibold">NIVEAU 3</Badge>
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center">
            ...
            {/* Niveau 4 - Coaching Privé */}
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center justify-between mb-6">
                <Badge className="bg-primary text-primary-foreground px-3 py-1 text-sm font-semibold">NIVEAU 4</Badge>
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center">
