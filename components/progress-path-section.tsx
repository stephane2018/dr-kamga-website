    ...
    <section className="relative py-20 bg-muted/30 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <SectionHeader
          ...
          description="Attaquez les marchés mondiaux sereinement... Comme des milliers d'exportateurs de produits locaux, nous vous aidons à organiser toute votre chaine de valeur pour devenir éligible au commerce international en boostant ainsi votre chiffre d'affaires."
