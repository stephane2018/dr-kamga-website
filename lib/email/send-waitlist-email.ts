      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div style="background: #f3f4f6; padding: 15px 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #222C57;">
              <p style="margin: 0 0 8px 0; font-size: 13px; color: #6b7280; font-weight: bold; text-transform: uppercase;">
                ${txt.masterclassLabel}
              </p>
              <p style="margin: 0; font-size: 17px; color: #222C57; font-weight: bold;">
...
`
  ...
  await transporter.sendMail({
    ...
    headers: {
      'X-Priority': '3',
      'X-Mailer': 'Nodemailer',
      'X-Entity-Ref-ID': `waitlist-user-${Date.now()}`,
    ...
    <html>
      <head>
        ...
        <style>
          ...
          .container { max-width: 650px; margin: 0 auto; padding: 20px; }
          .alert { background: #fbe9e7; border-left: 4px solid #222C57; padding: 15px 20px; margin-bottom: 20px; border-radius: 5px; }
...
${txt.footer}
  ...
  await transporter.sendMail({
    ...
    headers: {
      'X-Priority': '2',
      'X-Mailer': 'Nodemailer',
      'X-Entity-Ref-ID': `waitlist-team-${Date.now()}`,
      'Importance': 'high',
    },
  })
}
